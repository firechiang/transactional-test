package com.firecode.transactional.test.jms.service;
...
import com.firecode.transactional.test.jms.config.JmsConfig;
...
public class CustomerService {
    ...
    @Transactional(JmsConfig.JMS_TRANSACTIONMANAGER_NAME)
